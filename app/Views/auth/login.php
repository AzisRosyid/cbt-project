                ...
                <div class="card-body">
                  <form form action="<?= base_url('login'); ?>" method="post">
                    ...
                    <div class="input-group flex-nowrap col-lg-12 mb-4">
                      ...
                      <input type="text" class="form-control" placeholder="Password" aria-label="Username" aria-describedby="addon-wrapping" required="" minlength="8" name="password">
                    </div>
